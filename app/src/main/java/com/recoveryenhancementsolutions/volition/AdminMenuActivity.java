...
public class AdminMenuActivity extends AppCompatActivity
    ...
    private void toEditProfile() {
        final Intent intent = new Intent(AdminMenuActivity.this, ProfileActivity.class);
        startActivity(intent);
    }
    private void toEditTreatment() {
        Intent intent = new Intent(AdminMenuActivity.this, TreatmentPlanActivity.class);
        startActivity(intent);
    }
