...
public class TreatmentExperienceAssessmentViewModel extends AndroidViewModel {
     ...
     */
    public void setQuestionnaireAnswers(int value) {
   ...
   */
  private static class PopulateDbAsync extends AsyncTask<TreatmentExperienceAssessmentEntity, Void, Void> {

    public PopulateDbAsync(final VolitionDatabase db) {
      this.db = db;
    }
    ...
    private TreatmentExperienceAssessmentEntity tea;
  }
